@foreach($childs as $child)
  <tr class="border-t border-gray-300 text-gray-700 hover:bg-gray-100" data-tt-id="{{$child->id}}" data-tt-parent-id="{{$child->parent_id}}">
    ...
    @if(count($child->children))
      @include('child_categories',['childs' => $child->children])
    @endif
</tr>
@endforeach
